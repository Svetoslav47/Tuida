              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="mt-3 sm:mt-4">
                  <button
                    ...
                    className="w-full sm:w-auto px-4 py-2 text-sm font-light border border-gray-300 hover:border-gray-400 transition-colors"
                  >
                    Покажи повече
                  </button>
                </div>
