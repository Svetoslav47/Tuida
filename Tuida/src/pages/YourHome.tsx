  ...
  return (
    <div className="px-6 md:px-12 lg:px-16 py-6 h-full overflow-y-auto">
      <div className="max-w-6xl mx-auto">
        ...
        <VideoPlayer videoUrl="/video.mp4" title="ТУИДА HOMES" description="Отправете се на пътешествие през нашите внимателно проектирани пространства и усетете хармонията между модерното строителство и природните елементи." />
